...
<table>
<tr>
<td width="110" align="center"><a href="trip_planner/"><img src="trip_planner/images/icon.png" width="80" alt="旅行プランナー"></a></td>
<td><b><a href="trip_planner/">旅行プランナー</a></b>（v1.6）<br>予定カードを日ごとのボードに並べ、地図と予算で旅程を俯瞰。JSON で仲間に丸ごと渡せます。</td>
<td width="150" align="center"><img src="trip_planner/images/qr.png" width="140" alt="旅行プランナーのページの QR コード"></td>
</tr>
<tr>
<td align="center"><a href="career_log/"><img src="career_log/images/icon.png" width="80" alt="キャリアログ"></a></td>
<td><b><a href="career_log/">キャリアログ</a></b>（v1.2.0）<br>学歴・職歴・資格・実績を登録すると、RPG のステータス画面・統計・Wikipedia 風・履歴書の 4 通りで見せてくれる経歴アプリ。</td>
<td align="center"><img src="career_log/images/qr.png" width="140" alt="キャリアログのページの QR コード"></td>
</tr>
<tr>
<td align="center"><a href="whistle_trainer/"><img src="whistle_trainer/images/icon.png" width="80" alt="ホイッスルトレーナー"></a></td>
<td><b><a href="whistle_trainer/">ホイッスルトレーナー</a></b>（v1.1）<br>ティン・ホイッスル（D 管）の練習アプリ。譜面と運指を見ながら吹き、マイクで正誤を判定します。</td>
<td align="center"><img src="whistle_trainer/images/qr.png" width="140" alt="ホイッスルトレーナーのページの QR コード"></td>
</tr>
<tr>
...
<tr>
<td align="center"><a href="mask_camera/"><img src="mask_camera/images/icon.png" width="80" alt="MaskCamera"></a></td>
<td><b><a href="mask_camera/">MaskCamera</a></b>（v1.1）<br>好きな画像を重ねてマスクを作り、そのまま覗いて撮るカメラ。透過 PNG もそのまま使えます。</td>
<td align="center"><img src="mask_camera/images/qr.png" width="140" alt="MaskCamera のページの QR コード"></td>
</tr>
<tr>
...
<td><b><a href="phonetic_hound/">Phonetic Hound</a></b>（<b>開発中</b> v0.8.0-dev）<br>電波で操られたゾンビの街で、スマホの信号強度と到来方向を頼りに携帯基地局を探して制圧する TPS アクション。</td>
...
<p align="center"><img src="images/qr-top.png" width="140" alt="このページの QR コード"><br>このページの QR コード</p>
