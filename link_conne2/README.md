...
### [APK をダウンロード（v1.3.0・2.4 MB）](https://github.com/kijitora-no-hito/android-apps/releases/download/linkconne2-v1.3.0/linkconne2-1.3.0-release.apk)

| 項目 | 内容 |
| --- | --- |
| バージョン | 1.3.0（2026-09-24） |
| ファイル | `linkconne2-1.3.0-release.apk`（2,530,536 バイト） |
| SHA-256 | `B382EA084343E9D3B6909531368B9973BBE428AD3CD9E922F2A4FB1E786DAD79` |
| 対応 Android | 8.0 以上 |
...
- **チュートリアル** — 18 本。どれも「完成一手前」の盤面から始まり、解説を読みながら最後の一手を打つだけ。なぜその値になるのかを数字で説明します。
