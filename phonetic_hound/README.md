...
### [APK をダウンロード（v0.4.0-dev・10.1 MB）](https://github.com/kijitora-no-hito/android-apps/releases/download/phonetichound-v0.4.0-dev/phonetichound-0.4.0-dev-release.apk)

| 項目 | 内容 |
| --- | --- |
| バージョン | 0.4.0-dev（2026-09-26・開発中） |
| ファイル | `phonetichound-0.4.0-dev-release.apk`（10,632,368 バイト） |
| SHA-256 | `42EFD12917C0506052F4B47FB1355646502D7FC73B750C7944D43F81C7290DC8` |
