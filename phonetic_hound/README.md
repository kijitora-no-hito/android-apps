...
### [APK をダウンロード（v0.3.0-dev・10.1 MB）](https://github.com/kijitora-no-hito/android-apps/releases/download/phonetichound-v0.3.0-dev/phonetichound-0.3.0-dev-release.apk)

| 項目 | 内容 |
| --- | --- |
| バージョン | 0.3.0-dev（2026-09-25・開発中） |
| ファイル | `phonetichound-0.3.0-dev-release.apk`（10,631,808 バイト） |
| SHA-256 | `834747A07B515C41CF2CF093AC95E9F21729A32102380DBF8874E29F470CA282` |
