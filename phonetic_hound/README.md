...
### [APK をダウンロード（v0.6.0-dev・10.6 MB）](https://github.com/kijitora-no-hito/android-apps/releases/download/phonetichound-v0.6.0-dev/phonetichound-0.6.0-dev-release.apk)

| 項目 | 内容 |
| --- | --- |
| バージョン | 0.6.0-dev（2026-09-26・開発中） |
| ファイル | `phonetichound-0.6.0-dev-release.apk`（11,073,576 バイト） |
| SHA-256 | `CCBD69A403C53363204D9B952217CD58587D99A4168EF2026128B580BA68B96E` |
